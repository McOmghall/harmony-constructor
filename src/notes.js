...
const Notes = React.createClass({
  getInitialState: function () {
    ...
    return {
      ...
      showChordHelper: false
    }
  },
  render: function () {
	  var body

	  if (this.state.showChordHelper) {
    ...
    <a href='#' onClick={playChord}>{d}</a>
	  ...
	  return (
		  <div className='note-component'>
		    <div className='title'>
		      <a href='#' onClick={this.__toggleChordHelper}>
			          Chord helper
			        </a>
		    </div>
		    {body}
  ...
  __toggleChordHelper: function () {
    const toggled = (this.state.showChordHelper ? false : true)
    this.setState({showChordHelper: toggled})
  },
